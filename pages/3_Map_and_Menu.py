...
# =========================================================
# 6. ปุ่มเปลี่ยนหน้า (แยกออกมาไว้ด้านนอกสุด เพื่อให้ทำงานได้ 100%)
# =========================================================
st.markdown("---")
st.info("💡 คุณสามารถตรวจสอบยอดโควต้าพลังงานและโปรตีนคงเหลือทั้งหมดได้ตลอดเวลาที่หน้าโปรไฟล์")
if st.button("📊 ไปขั้นตอนต่อไป: ดูสรุปโปรไฟล์โภชนาการของคุณ", type="secondary", use_container_width=True):
